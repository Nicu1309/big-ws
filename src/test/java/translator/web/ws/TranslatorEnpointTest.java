...
public class TranslatorEnpointTest {
	...
	public void testSendAndReceive() {
		...
		request.setText("one does not simply commits this code");
		...
		assertThat(((GetTranslationResponse) response).getTranslation(), is("uno no simplemente comete este código"));
	}	
}
